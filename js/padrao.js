...
document.getElementById('dark-mode-toggle').addEventListener('click', function() {
    ...
    // Altera todos os elementos que devem mudar de acordo com o tema
    const elementsToToggle = document.querySelectorAll('header, nav, .menu-options li, .bottom-options button, h1, p, a, .dashboard, .indicator');
    elementsToToggle.forEach(function(element) {
        element.classList.toggle('dark-mode'); // Alterna a classe 'dark-mode' em cada elemento
    });
